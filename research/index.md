...
Recent focus: 1) **Surgical Robotics**, 2) **Agentic AI Systems for Healthcare Applications**, 3) **Human Robots** for Elderly Care, 4) **LLMs and Smart XR** for Medical Education
<br>
...
{% endcapture %}
{% include feature.html image="images/research/elderlycare.png" link="publication/?tag=elder-robot" title="Human Robots for Elderly Care" text=text className="feature-image" %}
