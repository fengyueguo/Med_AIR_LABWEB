...
{% endcapture %}
{% include feature.html image="images/research/agentic.jpg" link="publication/?tag=mia" title="Agentic AI Systems for Healthcare Applications" text=text className="feature-image" %}
...
{% endcapture %}
{% include feature.html image="images/research/robotic.jpg" link="publication/?tag=sur-robot" flip=true title="Surgical Robotics" text=text className="feature-image" %}
...
{% endcapture %}
{% include feature.html image="images/research/elderlycare.png" link="publication/?tag=elder-robot" title="Embodied AI for Elderly Care Robotics" text=text className="feature-image" %}
