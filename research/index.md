...
{% endcapture %}
{% include feature.html image="images/research/agentic.jpg" link="publication.html?tag=mia" title="Agentic AI Systems for Healthcare Applications" text=text className="feature-image" %}
...
{% endcapture %}
{% include feature.html image="images/research/robotic.jpg" link="publication" flip=true title="Surgical Robotics" text=text className="feature-image" %}
...
{% endcapture %}
{% include feature.html image="images/research/smartXR.png" link="publication" title="LLMs and Smart XR for Medical Education" text=text flip=true className="feature-image" %}
