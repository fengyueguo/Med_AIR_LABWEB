...
{% endcapture %}
{% include feature.html link="publication/?tag=elder-robot" flip=true title="Safe Embodied AI for General-Purpose Robot Manipulation" text=text className="feature-image" %}
