...
Recent focus: 1) **Embodied AI** for Elderly Care Robotics, 2) **Surgical Robotics**, 3) **LLM and smart XR** for medical education, 4) **Agentic AI systems** for healthcare applications.
{% 
  include figure.html 
